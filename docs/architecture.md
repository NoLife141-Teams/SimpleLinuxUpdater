...
- `internal/updates.Service` owns update, APT reconciliation/repair, autoremove, sudoers, approval, scheduled-scan, job, and audit runner behavior; it consumes Host Maintenance Session for authenticated host execution.
