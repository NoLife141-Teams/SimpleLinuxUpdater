...
receives another full timeout window. If no lock is active, the normal timeout
error is preserved.
...
```bash
docker run --env-file .env -p 8080:8080 -v debian-updater-data:/data ghcr.io/nolife141-teams/simplelinuxupdater:v0.4.2
```
