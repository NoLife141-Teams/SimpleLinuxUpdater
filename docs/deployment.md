...
```bash
docker run --env-file .env -p 8080:8080 -v debian-updater-data:/data ghcr.io/nolife141-teams/simplelinuxupdater:v0.3.0
```
...
```bash
docker pull ghcr.io/nolife141-teams/simplelinuxupdater:v0.3.0
```
