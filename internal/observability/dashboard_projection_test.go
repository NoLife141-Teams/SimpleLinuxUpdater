...
func TestDashboardProjectionRecommendsSafeNextMaintenanceAction(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "sudo policy failure", status: "error", timeline: testCollectedTimeline("done_error", "error", "Failed"), health: DashboardHealthInfo{DiskStatus: "ok", AptStatus: "ok"}, triageTime: testCollectedTriageTime("fresh", "now"), failure: dashboardMaintenanceFailureFacts{errorClass: "sudo_policy"}, wantKey: "enable_apt_access", wantAction: dashboardActionEnableApt},
		{name: "sudo policy failure with stale facts", status: "error", timeline: testCollectedTimeline("done_error", "error", "Failed"), triageTime: testCollectedTriageTime("stale", ""), failure: dashboardMaintenanceFailureFacts{errorClass: "sudo_policy"}, wantKey: "enable_apt_access", wantAction: dashboardActionEnableApt},
